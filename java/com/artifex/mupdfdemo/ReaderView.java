...
public class ReaderView
	...
	public void refresh(boolean reflow, float zoom) {
		mReflow = reflow;
		mReflowChanged = true;
		mResetLayout = true;
	...
	private void measureView(View v) {
		...
		v.measure(View.MeasureSpec.EXACTLY | (int)(v.getMeasuredWidth()*(scale+mZoom)*mScale),
				View.MeasureSpec.EXACTLY | (int)(v.getMeasuredHeight()*(scale+mZoom)*mScale));
		} else {
	...
	private void slideViewOntoScreen(View v) {
		...
		if (corr.x != 0 || corr.y != 0) {
			mScrollerLastX = mScrollerLastY = 0;
			mScroller.startScroll(0, 0, corr.x, corr.y, 1500);
			mStepper.prod();
		}
	}
